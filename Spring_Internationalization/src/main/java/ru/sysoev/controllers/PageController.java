...
import ru.sysoev.models.Product;
...
public class PageController {
	...
	private List<Product> fetchProducts() {
		...
		product.setLastUpdated(localizeDate(locale, LocalDate.of(2022, Month.SEPTEMBER, 22)));
		...
		product.setLastUpdated(localizeDate(locale, LocalDate.of(2022, Month.SEPTEMBER, 20)));
		products.add(product);
		return products;
	}
